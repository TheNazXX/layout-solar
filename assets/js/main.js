(function (){
  let tabs = document.getElementsByClassName('info__tabs-item')
  for(let tab of tabs){
    tab.addEventListener('click',function(event){
      event.preventDefault();

      for(let tab of tabs){
        tab.classList.remove('info__tabs-item--active')
      }

      this.classList.add('info__tabs-item--active')

      let contents = document.getElementsByClassName('info__tabs-content')
      for(let content of contents){
        content.classList.remove('info__tabs-content--active')
      }

      let href = this.getAttribute('href')
      let elem = document.querySelector(href)
      elem.classList.add('info__tabs-content--active')
